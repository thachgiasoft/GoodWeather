...
struct MusicPlayerView: View {
    ...
    var body: some View {
        VStack {
            ...
            HStack {
                NeumorphicImageButton(systemName: "backward.fill", size: CGSize(width: 25, height: 25)) {}.foregroundColor(Color.black)
                
                Spacer()
                
                NeumorphicImageButton(systemName: "stop.fill", size: CGSize(width: 25, height: 25)) {}.foregroundColor(Color.black)
                
                Spacer()
                
                NeumorphicImageButton(systemName: "forward.fill", size: CGSize(width: 25, height: 25)) {}.foregroundColor(Color.black)
            }
            .padding()
